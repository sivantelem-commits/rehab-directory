        ...
        <main style={{ maxWidth: 740, margin: '0 auto', padding: '32px 16px' }}>
          ...
          <div id="sal">
            <Card color="#6B21A8" icon="📋" title="איך מקבלים זכאות לסל שיקום?">
              <p style={pStyle}>סל השיקום הוא זכות חוקית שמגיעה לאנשים עם מגבלה נפשית ע"פ קריטריונים מסויימים. הדרך לקבל אותו עוברת בשני שלבים:</p>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 16 }}>
                {[
                  ...
                  {
                    num: '2',
                    title: 'משרד הבריאות - סל שיקום',
                    text: 'לאחר קבלת קצבת נכות מהביטוח הלאומי (עבור לפחות 40% נכות נפשית), פנה לקופת החולים לעו"ס על מנת לכתוב בקשה לסל שיקום. העו"ס יעזור לך בהתנהלות הבירוקרטית.',
                    color: '#4C0080',
                  },
                ].map(s => (
