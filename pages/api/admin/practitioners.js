...
export default async function handler(req, res) {
  ...
  if (req.method === 'PATCH') {
    ...
    const EDITABLE = ['name','profession','city','district','phone','website','price_range','bio','photo_url',
                      'treatment_types','specializations','health_funds','languages','is_online','is_defense_ministry','license_number','whatsapp_available','has_health_fund_agreement','lat','lng']
