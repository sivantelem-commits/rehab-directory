  ...
  return (
    <>
      ...
      <div dir="rtl" style={{ fontFamily: "'Nunito', sans-serif", minHeight: '100vh', background: '#f7f0ff' }}>
        ...
        {/* ── פילטרים - נייד ── */}
        {isMobile && (
          <div style={{ background: 'white', borderBottom: '1px solid #d4b0f0', padding: '8px 12px 10px' }}>
            {/* שורה עליונה: פילטרים + מונה */}
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
              <button onClick={() => setShowSheet(true)} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 18px', borderRadius: '999px', border: `2px solid ${activeExtraFilters > 0 || category !== 'הכל' || subcategory !== 'הכל' ? '#8B00D4' : '#d4b0f0'}`, background: activeExtraFilters > 0 || category !== 'הכל' || subcategory !== 'הכל' ? '#8B00D4' : 'white', color: activeExtraFilters > 0 || category !== 'הכל' || subcategory !== 'הכל' ? 'white' : '#4C0080', fontWeight: 700, fontSize: 14, cursor: 'pointer', fontFamily: "'Nunito', sans-serif" }}>
                🎯 פילטרים
              ...
              <span style={{ fontSize: 13, color: '#9B00CC', fontWeight: 700 }}>
            ...
            <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
              {DISTRICTS.map(d => {
                ...
                const active = district === d
                return (
                  <button key={d} onClick={() => setDistrict(d)} style={{ padding: '5px 12px', borderRadius: '999px', fontSize: 12, fontWeight: 600, border: `2px solid ${active ? (isNat ? '#1A3A5C' : '#8B00D4') : '#e0d0f0'}`, background: active ? (isNat ? '#1A3A5C' : '#8B00D4') : 'white', color: active ? 'white' : '#4C0080', cursor: 'pointer', fontFamily: "'Nunito', sans-serif" }}>{d}</button>
                )
              })}
            </div>
          </div>
