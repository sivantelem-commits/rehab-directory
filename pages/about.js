      ...
      <div dir="rtl" style={{ fontFamily: 'Arial, sans-serif', minHeight: '100vh', background: '#F0F7FF' }}>
        ...
        <main style={{ maxWidth: 740, margin: '0 auto', padding: '36px 16px' }}>
          ...
          <Card color="#0277BD" icon="🏥" title="הנגשת מידע לאנשים במשבר ולמטפלים בהם">
            <p style={p}>אחד האתגרים הגדולים ביותר בבריאות הנפש בישראל הוא הפער בין השירותים הקיימים לבין היכולת למצוא אותם. מסגרות טיפוליות רבות — בתי מאזנים, מחלקות אשפוז, מרפאות יום וחדרי מיון פסיכיאטריים — אינן מוכרות לציבור הרחב, ואפילו לא תמיד לאנשי מקצוע בתחום.</p>
            <p style={p}>הפורטל שואף להנגיש את המידע הזה לכולם: למטופלים, למשפחות, לעובדים סוציאליים, לפסיכיאטרים ולכל מי שצריך לדעת מה קיים ואיפה. כי ידע הוא כוח — ובמשבר, הוא יכול להיות ההבדל.</p>
          </Card>

          <Card color="#F47B20" icon="♿" title="מציאת מסגרות שיקום — חשיפה למה שמגיע לכם">
            <p style={p}>סל השיקום הוא זכות חוקית של כל אדם עם מוגבלות נפשית בישראל — אך רבים אינם יודעים שהיא קיימת, ועוד יותר אינם יודעים כיצד לממש אותה.</p>
            <p style={p}>שירותי הסל מגוונים ועשויים לכלול: דיור מוגן בקהילה, תעסוקה נתמכת, השלמת השכלה, מועדונים חברתיים, ליווי שיקומי אישי ועוד. כל אחד מהם יכול לשמש נדבך בדרך חזרה לחיים מלאים ועצמאיים.</p>
