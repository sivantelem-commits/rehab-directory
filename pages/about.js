  ...
  return (
    <>
      ...
      <div dir="rtl" style={{ fontFamily: 'Arial, sans-serif', minHeight: '100vh', background: '#FFF8F3' }}>
        ...
        <div style={{ background: 'linear-gradient(135deg, #1A3A5C, #2A5298)', color: 'white', padding: '52px 32px', textAlign: 'center' }}>
          <div style={{ fontSize: 48, marginBottom: 14 }}>♿</div>
          <h1 style={{ fontSize: 30, fontWeight: 800, margin: '0 0 10px' }}>אודות האתר</h1>
          <p style={{ fontSize: 16, opacity: 0.85, margin: 0 }}>כל מה שצריך לדעת על סל שיקום והמאגר</p>
        </div>

        <main style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px' }}>

          <div style={{ background: 'white', borderRadius: 20, padding: '32px', marginBottom: 24, boxShadow: '0 4px 16px rgba(0,0,0,0.07)', borderRight: '5px solid #F47B20' }}>
            <h2 style={{ fontSize: 22, fontWeight: 800, color: '#1A3A5C', margin: '0 0 16px' }}>🧩 מה זה סל שיקום?</h2>
          ...
          <div style={{ background: 'white', borderRadius: 20, padding: '32px', marginBottom: 24, boxShadow: '0 4px 16px rgba(0,0,0,0.07)', borderRight: '5px solid #1A3A5C' }}>
            <h2 style={{ fontSize: 22, fontWeight: 800, color: '#1A3A5C', margin: '0 0 16px' }}>💡 למה הכנו את האתר?</h2>
            <p style={{ fontSize: 15, color: '#334', lineHeight: 1.8, margin: 0 }}>
          ...
          <div style={{ background: 'white', borderRadius: 20, padding: '32px', marginBottom: 24, boxShadow: '0 4px 16px rgba(0,0,0,0.07)', borderRight: '5px solid #2E7D32' }}>
            <h2 style={{ fontSize: 22, fontWeight: 800, color: '#1A3A5C', margin: '0 0 16px' }}>🔍 איך משתמשים באתר?</h2>
          ...
          <div style={{ background: 'white', borderRadius: 20, padding: '32px', boxShadow: '0 4px 16px rgba(0,0,0,0.07)', borderRight: '5px solid #C2185B' }}>
            <h2 style={{ fontSize: 22, fontWeight: 800, color: '#1A3A5C', margin: '0 0 16px' }}>🏢 אתם נותני שירות?</h2>
            <p style={{ fontSize: 15, color: '#334', lineHeight: 1.8, marginBottom: 16 }}>
