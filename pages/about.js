      ...
      <div dir="rtl" style={{ fontFamily: "'Nunito', sans-serif", minHeight: '100vh', background: '#F0F7FF' }}>
        ...
        <main style={{ maxWidth: 740, margin: '0 auto', padding: '36px 16px' }}>
          ...
          <Card color="#1A3A5C" icon="💙" title="למה נוצר הפורטל הזה?">
            ...
            <p style={p}>מי שנמצא במשבר נפשי לא תמיד יודע מה קורה לו, מה מגיע לו, ולאן לפנות. בני משפחה וחברים רוצים לעזור — אבל גם הם לא יודעים מאיפה להתחיל.</p>
          ...
          <Card color="#0277BD" icon="🏥" title="מידע לאנשים במשבר ולמי שמלווה אותם">
            ...
            <p style={p}>הפורטל רוצה לעזור לכולם למצוא את המידע הזה: למטופלים, למשפחות, לעובדים סוציאליים ולכל מי שצריך לדעת מה קיים ואיפה.</p>
          </Card>

          <Card color="#4C0080" icon="♿" title="שירותי שיקום — דעו מה מגיע לכם">
            <p style={p}>סל השיקום הוא זכות חוקית של אנשים עם מגבלה נפשית בישראל — אבל הרבה אנשים פשוט לא יודעים שהיא קיימת, ועוד פחות יודעים איך לממש אותה.</p>
          ...
          <Card color="#2E7D32" icon="🤝" title="איך אפשר לעזור?">
            ...
            <p style={p}>אם אתם מזהים מידע שגוי או חסר — נשמח לשמוע. ביחד נוכל לבנות מאגר מידע מהימן ועדכני לכל מי שצריך אותו.</p>
