      ...
      <div dir="rtl" style={{ fontFamily: "'Nunito', sans-serif", minHeight: '100vh', background: '#F0F7FF' }}>
        ...
        <main style={{ maxWidth: 740, margin: '0 auto', padding: '36px 16px' }}>
          ...
          <Card color="#1A3A5C" icon="💙" title="למה נוצר הפורטל הזה?">
            ...
            <p style={p}>מי שנקלע למשבר נפשי חווה לעיתים קרובות חוסר וודאות עמוק לגבי מה קורה לו, מה מגיע לו, ולאן לפנות. בני משפחה, חברים, אנשי מקצוע - חווים גם הם חוסר אונים: הם רוצים לעזור, אבל לא יודעים מאיפה להתחיל.</p>
          ...
          <Card color="#F47B20" icon="♿" title="מציאת מסגרות שיקום - דעו מה ההיצע הקיים">
            ...
            <p style={p}>הפורטל מרכז את כל המסגרות הללו במקום אחד, מסודרות לפי אזור גיאוגרפי וקטגוריה - כדי שתוכלו לגלות מה קיים בקרבתכם, להשוות ולמצוא את המסגרת שמתאימה לצרכים שלכם.</p>
          </Card>
