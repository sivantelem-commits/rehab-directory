      ...
      <div dir="rtl" style={{ fontFamily: 'Arial, sans-serif', minHeight: '100vh', background: '#F0F7FF' }}>
        ...
        <main style={{ maxWidth: 740, margin: '0 auto', padding: '36px 16px' }}>
          ...
          <Card color="#F47B20" icon="♿" title="מציאת מסגרות שיקום - חשיפה למה שמגיע לכם">
            <p style={p}>סל השיקום הוא זכות חוקית של אנשים עם מגבלה נפשית בישראל (מרף מסויים), אך רבים אינם יודעים שזכות זו קיימת, ועוד יותר אינם יודעים כיצד לממש אותה.</p>
            <p style={p}>שירותי הסל מגוונים וכוללים את התחומים הבאים: שירותי דיור, תעסוקה, השכלה, חברה ופנאי, תיאום טיפול ועוד. כל אחד מהם יכול לשמש נדבך בדרך חזרה לחיים מלאים ועצמאיים.</p>
