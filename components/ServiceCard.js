...
export default function ServiceCard({ service }) {
  ...
  return (
    <div style={{ background: 'white', borderRadius: 16, padding: '20px 22px', cursor: 'pointer', boxShadow: '0 4px 16px rgba(0,0,0,0.07)', border: `1.5px solid ${isTreatment ? '#a0d8e8' : '#d4b0f0'}`, borderTop: `4px solid ${color}`, transition: 'transform 0.15s, box-shadow 0.15s', display: 'flex', flexDirection: 'column', minHeight: '180px' }}
